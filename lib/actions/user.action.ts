...
export const signUp = async ( {password, ...userData}: SignUpParams) => {
    const { email, firstName, lastName} = userData; //De-structuring
...
export const exchangePublicToken = async ({
    ...
    try {
        //Exchange public token for access token and itemm ID
        ...
        //revalidate the path to reflect the chages
        revalidatePath('/');
        ...
        console.log('An error occurred while creating exchnaging token: ', error)
